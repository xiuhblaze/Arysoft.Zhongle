...
namespace Arysoft.ProyectoN.Controllers
{
    ...
    public class UsersAdminController : Controller
    {
        ...
        public async Task<ActionResult> Edit([Bind(Include = "Email,Id,Nombres,ApellidoPaterno,ApellidoMaterno,CURP")] EditUserViewModel editUser, params string[] selectedRole)
        {
            if (ModelState.IsValid)
            {
